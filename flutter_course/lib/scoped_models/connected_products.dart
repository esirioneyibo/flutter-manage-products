...
mixin ProductsModel on ConnectedProductsModel {
  ...
  Future<bool> addProduct(
    ...
    try {
      final http.Response response = await http.post(
          'https://flutter-products-f8ba8.firebaseio.com/products.json?auth=${_authenticatedUser.token}',
  ...
  Future<bool> updateProduct(
    ...
    return http
        .put(
            'https://flutter-products-f8ba8.firebaseio.com/products/${selectedProduct.id}.json?auth=${_authenticatedUser.token}',
  ...
  Future<bool> deleteProduct() {
    ...
    return http
        .delete(
            'https://flutter-products-f8ba8.firebaseio.com/products/${deletedProductId}.json?auth=${_authenticatedUser.token}')
...
mixin UserModel on ConnectedProductsModel {
  ...
  Future<Map<String, dynamic>> authenticate(String email, String password,
    ...
    if (mode == AuthMode.Login) {
      ...
      response = await http.post(
          'https://www.googleapis.com/identitytoolkit/v3/relyingparty/signupNewUser?key=AIzaSyAUGgWUqA7uDTpO8dFI4urZFeY_2NWU2Jo',
          body: json.encode(authData),
          headers: {'Content-Type': 'application/json'});
    }
